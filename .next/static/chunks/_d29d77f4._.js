...
function LoginPage() {
    ...
    const handleLogin = async (event)=>{
        ...
        setLoading(true);
        try {
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(form.email.value, form.password.value);
            if (success) {
...
_s(LoginPage, "w0Hj35jkVDfGDZ/KC017Kd0uv6g=", false, function() {
    return [
...
//# sourceMappingURL=_d29d77f4._.js.map